...
try {
    ...
    put('SENDER_DEBUG_E2E_URL', c.url)
    put('SENDER_DEBUG_E2E_USER', c.user)
    put('SENDER_DEBUG_E2E_PASS', c.pass)
    put('SENDER_DEBUG_E2E_CLUSTER', c.cluster)
}
...
export default defineConfig({
    ...
    reporter: [['list']],
    use: {
        baseURL: process.env.SENDER_DEBUG_E2E_URL ?? 'http://localhost:3000',
        headless: true,
