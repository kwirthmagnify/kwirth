...
export interface IAsset {
    ...
    namespace: string
    container: string
    unknown: { statusCode: number; statusMessage: string }
    vulnerabilityreports: { report: any }
    configauditreports: { report: any }
    sbomreports: { report: any }
    exposedsecretreports: { report: any }
}
