...
Kwirth currently ships with the following providers:
  ...
  - **[Business](./providers?id=business)**. Ingests external business data into Kwirth via HTTP POST and distributes it to subscribed channels.
