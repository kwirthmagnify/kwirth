...
As of Kwirth version 0.5.21, these are the existing channels:
  ...
  - **[Censor](./channels?id=censor)**. LLM-based log noise filtering: learn regex patterns automatically and filter out boilerplate so only meaningful lines reach your screen.
