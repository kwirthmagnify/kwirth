...
Kwirth can also delegate authentication to an external Identity Provider (Single Sign-On). See [IdP integration](/0.6.31/idp/index) for details.
...
3. Enter user data
   ...
   - Password
4. Add resources that the user will be able to access. This is a list, you can add different resources and permissions.
