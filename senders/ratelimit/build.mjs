...
const distMeta = { type: 'commonjs', extensionType: 'sender', id: meta.id, name: meta.name, displayName: meta.displayName, version: meta.version, description: meta.description }
