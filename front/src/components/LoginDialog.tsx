                            ...
                            ? <Box sx={{ display: 'grid', gridTemplateColumns: 'repeat(3, minmax(0, 1fr))', gap: 1.5 }}>
                                {filteredInstalled.map(login => (
                                    <LoginCard
                                        ...
                                        action={
                                            <Tooltip title={login.installedFrom === 'dev' ? 'Dev login extensions cannot be uninstalled' : 'Uninstall'}>
                                                <span>
                                                    <IconButton size='small' color='error' disabled={login.installedFrom === 'dev' || uninstallingId === login.id} onClick={() => uninstall(login)}>
