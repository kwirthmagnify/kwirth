...
const ContextSelector: React.FC<IContextSelectorProps> = (props:IContextSelectorProps) => {
    ...
    return (<>
        ...
        <Dialog open={clusterDialogOpen} disableRestoreFocus>
            <DialogTitleHelp section='guide/admin/06-cluster-management?id=add-a-remote-cluster' docsUrl={docsUrl(backendUrl, 'core', 'kwirth')}>{clusterDialogEditIndex === null ? 'Add cluster' : 'Edit cluster'}</DialogTitleHelp>
