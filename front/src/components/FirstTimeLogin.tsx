...
const FirstTimeLogin: React.FC<IFirstTimeLoginProps> = (props:IFirstTimeLoginProps) => {
    ...
    return (<>
        <Dialog open={true} disableRestoreFocus={true} fullWidth maxWidth={'md'}>
            <DialogTitleHelp section='guide/user/02-access?id=logging-in-with-a-local-account' docsUrl={docsUrl(backendUrl, 'core', 'kwirth')}>First time here...</DialogTitleHelp>
            <DialogContent>
                <Typography>
